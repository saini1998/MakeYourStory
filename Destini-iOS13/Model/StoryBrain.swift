...
struct StoryBrain {
    ...
    mutating func nextStory(_ userDestination: Int){
        storyNumber = userDestination
    }
    
    mutating func getDestination(_ userChoice: String) -> Int {
        var dest: Int = 0
        if userChoice == story[storyNumber].choice1{
            dest = story[storyNumber].choice1Destination
        }else if userChoice == story[storyNumber].choice2{
            dest = story[storyNumber].choice2Destination
        }
        return dest
    }
}
